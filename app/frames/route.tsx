  ...
  const ScoreScreen = () => {
    return (
      <div tw="flex flex-col w-full h-full relative">
        ...
        <div tw="flex text-[39px] justify-end w-2/4 absolute bottom-2 left-118 text-[#ffeb5b] font-['Poppins']">${formatNumber(parseFloat(moxieData?.lifetime.allEarningsAmount || "0") * moxiePriceUSD)}</div>
